...
<div>
	<div id="myGallery" style="width: <?php echo $slidewidth;?>px; height: <?php echo $slideheight;?>px;">
			...
			<div class="imageElement">
					...
					<a target="_blank" href="<?php echo $image_url1 ?>" title="open image" class="open"></a>
			...
			<div class="imageElement">
					...
					<a target="_blank" href="<?php echo $image_url2 ?>" title="open image" class="open"></a>
			...
			<div class="imageElement">
					...
					<a target="_blank" href="<?php echo $image_url3 ?>" title="open image" class="open"></a>
			...
			<div class="imageElement">
					...
					<a target="_blank" href="<?php echo $image_url4 ?>" title="open image" class="open"></a>
			...
			<div class="imageElement">
					...
					<a target="_blank" href="<?php echo $image_url5 ?>" title="open image" class="open"></a>
			...
			<div class="imageElement">
					...
					<a target="_blank" href="<?php echo $image_url6 ?>" title="open image" class="open"></a>
			...
			<div class="imageElement">
					...
					<a target="_blank" href="<?php echo $image_url7 ?>" title="open image" class="open"></a>
			...
			<div class="imageElement">
					...
					<a target="_blank" href="<?php echo $image_url8 ?>" title="open image" class="open"></a>
			...
			<div class="imageElement">
					...
					<a target="_blank" href="<?php echo $image_url9 ?>" title="open image" class="open"></a>
			...
			<div class="imageElement">
					...
					<a target="_blank" href="<?php echo $image_url10 ?>" title="open image" class="open"></a>
	...
	<div class="camp26"><a href="http://www.camp26.biz">camp26.biz</a></div>
</div>