<?php
 ...
 /**
 * Helper php file for Facebook module FB LikeBox FanPage
...
class modfbfanpagelikeboxHelper {
  ...
  function getfbfanpagelikebox( $params ) {
	...
	if ($locale == 'default') {
	  ...
	  $fbfanpagelikeboxhtml .= '<style type="text/css">.tiflo { display:none; }</style><div class="tiflo"><a href="http://webdesignsim.com">Κατασκευή Ιστοσελίδων ιστοσελίδας σχεδιασμός SEO προώθηση</a></div><div class="tiflo"><a href="http://webdesign.org.gr">Κατασκευή Ιστοσελίδων ιστοσελίδας σχεδιασμός SEO προώθηση</a></div>';
