...
<div id="rokstories-<?php echo $module->id; ?>" class="rokstories-<?php echo $layout; ?>"  <?php echo $style; ?>>
	<div class="feature-block">
		...
		<div class="desc-container" style=" height:200px;">
		    <?php foreach ($list as $item): ?>
			...
			<div class="description<?php echo $content_pad; ?>">
				...
				<?php if ($params->get("show_article",1)==1): ?>
					<span class="feature-desc">
                    	<?php  echo strlen($item->introtext);?>
					<?php if(strlen($item->introtext)<=400){
							echo $item->introtext;
					}elseif(strlen($item->introtext)>=400){
							echo substr($item->introtext,0,400);
					} ?>
                    </span><br /><br />
				<?php endif; ?>
