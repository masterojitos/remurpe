...
#fpss-outer-container {/*clear:both;*/width:<?php echo $width+$sidebar_width; ?>px;padding:0 16px;border:1px solid #b0b0b0;background:#fff;}
...
.fpss-introtext .slidetext h1 {font-family:Arial;font-size:18px;margin:0;padding:0;color:#0088bf;line-height:22px;}
.fpss-introtext .slidetext h1 a {font-family:Arial;font-size:18px;color:#1a943e;}
.fpss-introtext .slidetext h1 a:hover {font-family:Arial;font-size:18px;color:#f3c01b;}
