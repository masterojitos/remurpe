 ...
 * @version $Id: default.php 6669 2011-06-09 09:15:52Z trungnq $
			...
			<!-- ALTERNATIVE CONTENT BEGIN -->
				...
				<div class="jsnis-altcontent" style="width:<?php echo $width;?>; height:<?php echo $height;?>px;">
					<?php if($this->showlistInfo['alternative_status'] == 0){  ?>
						<div>
							<p><?php echo JText::_('SITE SHOW YOU NEED FLASH PLAYER'); ?>!</p>
							<p>
								<a href="http://www.adobe.com/go/getflashplayer">
									<?php echo JText::_('SITE SHOW GET FLASH PLAYER'); ?>
								</a>
							</p>
						</div>
					<?php }?>
