                    ...
                    <td  width="20" class="buttonheading" align="right">
						...
						if ($cfg->get('jev_debug', 0)) {
							...
							if ($jevtype=="jevent"){
								...
								echo JEV_CommonFunctions::jEventsLinkCloaking(
								$row->vCalExportLink(),
								'<img src="'. JURI::root() . 'components/'.JEV_COM_COMPONENT.'/views/'.$this->getViewName().'/assets/images/vcal.gif" align="middle" alt="vCalendar export" border="0" />',
