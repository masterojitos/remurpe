...
DEFINE("_DEBUGREPORT","Debug Report for Upload");
DEFINE("_SENDMAILTOADMIN","Send mail to site admin");
DEFINE("_SENDMAILTOADMININFO","Send mail that contains debug report to admin. The email address will be taken from your Joomla configuration.");
DEFINE("_SENDMAILTOCOMPONENTAUTHOR","Send mail to author");
DEFINE("_SENDMAILTOCOMPONENTAUTHORINFO","Send mail that contains debug report to Seyret author. Please don't enable this option unless author requests it.");
DEFINE("_WRITETOFILE","Write report to file");
DEFINE("_WRITETOFILEINFO","If you cannot get debug report via email, try enabling this option. Seyret will try to write debug report to files at administrator/components/com_seyret/up#.php files.");
