...
DEFINE("_PAGE","Page");
DEFINE("_VIDEOLISTHEADERPRE","Vidéos catégorie \"");
...
DEFINE("_NEW_VIDEO","Nouvelle Vidéo");
DEFINE("_VSERVERTYPE","Type de Serveur");
DEFINE("_VSERVERCODE","Code Serveur");
DEFINE("_NEWVIDEOCOMMENT","La meilleure façon d'ajouter une nouvelle vidéo c'est d'utiliser le panneau en frontend, connecté en tant qu'administrateur. Vous allez entrer le lien du vidéo et le système va entrer les informations de la vidéo automatiquement. Ici vous devez entrer les informations manuellement. <br> Si vous éditez une vidéo et n'êtes pas certain concernant les informations de la vidéo, ne changez pas le type de serveur de vidéo, le code serveur du vidéo et l'adresse de la vignette. Sinon le composant risque de ne plus fonctionner.");
DEFINE("_APPLY","Appliquer");
DEFINE("_SAVE","Sauvegarder");
DEFINE("_INPUTLINK","Le lien de la vidéo");
...
DEFINE("_ADDVIDEO","Vidéos Ajoutées");
DEFINE("_PENDINGVID","Vidéos en attente");
DEFINE("_SORTBY","Trié par");
DEFINE("_NOSERVERFOUNDREPORTIT","Désolé, mais on ne peut pas trouver de serveur de vidéo approprié au lien de la vidéo. Si vous êtes certain que le lien de la vidéo est correct, veuillez contacter l'administrateur du site.");
...
DEFINE("_POPUPVIDEOWIDTH","Largeur de la fenêtre popup de la vidéo");
DEFINE("_POPUPVIDEOHEIGHT","Hauteur de la fenêtre popup de la vidéo");
DEFINE("_DEFAULTSORTBY","Tri des vidéos par défaut");
DEFINE("_DEFAULTSORT","Ordre de tri par défaut");
DEFINE("_POPUPVIDEOWIDTHINFO","Définir ici la largeur de la vidéo dans la fenêtre popup. Les dimensions de la fenêtre vont être 100px de plus que les dimensions de la vidéo.");
DEFINE("_POPUPVIDEOHEIGHTINFO","Définir ici la largeur de la vidéo dans la fenêtre popup.");
...
DEFINE("_DELETEVIDEOCONFIRMMESSAGE","Êtes-vous certain? Cette vidéo va être supprimé définitivement."); 
...
DEFINE("_CANSEEREPORTEDVIDESBUTTON","Peu voir le boutons des vidéos signalées");
...
DEFINE("_CANREPORTVIDEOS","Peu signaler des vidéos ");
...
DEFINE("_VIDEOADDEDSUCCESFULLY","Vidéo ajoutée avec succès ! ");
DEFINE("_CANSEEVIDEOSERVERDETAILS","Peu voir les détails des vidéos sur le serveur");
...
DEFINE("_IMAGEADS","Image ajoutée en intro");
DEFINE("_VIDEOADS","Vidéo ajoutée en intro");
...
DEFINE("_FIREBOARDCATEGORYFORDISCUSSINFO","Indiquez ici le nombre maximal de sujets pour lesquel vous autorisez les discussions pour le composant FIREBOARD");
DEFINE("_LEAVEVIDEOLINK","Montrer le lien des vidéos");
DEFINE("_LEAVEVIDEOLINKINFO","Vous pouvez choisir de cacher ou montrer le lien exact des vidéos ici");
...
DEFINE("_SHOWVIDEOTOOLTIPSINFO","Choisissez ici si vous désirez fournir une aide intéractive à vos visiteurs au passage de la souris pour vos vidéos publiées");
DEFINE("_SHOWCATEGORYTOOLTIPS","Montrer les Tooltip pour les catégories de vidéos ?");
...
DEFINE("_DISCUSSIONONFORUM","Forum de discussion sur cette vidéo");
...
DEFINE("_INPUTFBDISCUSSTOPIC","Sujet de la discussion");
...
DEFINE("_LOCALVIDEO","Vidéo locale");
...
DEFINE("_LOCALFILESDIRECTORYINFO","Indiquez le chemin par défaut pour stocker les vidéos que vous téléchargez en local sur votre propre serveur");
DEFINE("_LOCALADSDIRECTORY","Chemin pour les vidéos locales ajoutées");
DEFINE("_LOCALADSDIRECTORYINFO","Indiquez ici le chemin exact ou seront stockées les vidéos pour vos introductions, cette fonction est exclusivement resérvé à la version PRO");
...
DEFINE("_RSSCHANNELTITLEPRE","Dernière vidéo dans catégorie");
...
DEFINE("_UNPROCESSEDFILEINFO","Il y a un non envoi de la vidéo sur votre compte. Si vous souhaitez la partager, vous devez remplir correctement le processus de publication. Si vous ne vous présentez pas, votre vidéo sera supprimée après un certain délai.");
...
DEFINE("_SELECTVIDEOSTOUPLOADINFO","Sélectionnez les vidéos que vous voulez charger. Une fois que vous avez choisi, elles seronts ajoutées à la file d'envoi.");
...
DEFINE("_CANEDITOWNVIDEO","Peuvent modifier une seule vidéo");
...
DEFINE("_RSSCHANNELTITLEHIGHESTRATEDPRE","Vidéo la mieux notée dans la catégorie");
DEFINE("_RSSCHANNELTITLEHIGHESTRATEDPOST","");
...
DEFINE("_VIDEOCONVERTSUCCESS","Votre vidéo à été traitée avec succès.");
DEFINE("_VIDEOCONVERTPOSTPONED","Votre vidéo sera bientôt validée par l'administrateur.");
...
DEFINE("_PLEASESELECTTHUMBNAIL","Veuillez sélectionner un aperçu pour votre vidéo");
...
DEFINE("_SIZEEXCEEDCOMPONENTCONF","Échec de l'envoi. Votre vidéo dépasse la taille maximale autorisée.");
...
DEFINE("_NOTUPLOADEDERROR","Le fichier vidéo n'est pas transféré. Veuillez essayer à nouveau.");
...
DEFINE("_ORIGINALVIDEOISHERE","Voir la vidéo dans son contexte original"); 
...
DEFINE("_FORCEREENCODEOLDFLV","Forcez les vidéos téléchargées à être réencodées en flv avec vos réglages.");
...
DEFINE("_HIGHESTRATEDVIDEOS","Meilleures notes");
...
DEFINE("_VIDEORESPONSESYSTEMINFO","Activer le système de réponse vidéo. Fonctionne avec la version Pro seulement.");
