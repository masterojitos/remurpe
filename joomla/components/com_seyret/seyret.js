...
//*************************************
		...
		function handleResponseVideo() {
			...
			if(seyrethttp.readyState == 4){
				...
				if ($defined($("seyretfbdiscussinput"))){
					...
					document.getElementById("mediaspace").innerHTML=document.getElementById("hiddenvideoembed").innerHTML;;
		...
		function showembedcodeafterad(){
			...
			document.getElementById("mediaspace").innerHTML = hembedcode;
