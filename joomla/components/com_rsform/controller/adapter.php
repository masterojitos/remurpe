...
DEFINE('_RSFORM_KEY','jSharing');
DEFINE('_RSFORM_COPYRIGHT','&copy;2007-2009 sharing.com');
DEFINE('_RSFORM_LICENSE','GPL Commercial License');
DEFINE('_RSFORM_AUTHOR','<a href="http://jsharing.com" target="_blank">jsharing.com</a>');
DEFINE('_RSFORM_WEBSITE','http://jsharing.com/');
